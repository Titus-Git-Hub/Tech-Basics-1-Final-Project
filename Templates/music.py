...
pygame.init()
pygame.font.init()  # <- THAT WAS CHANGED (added)

def write_lines(
    dest: pygame.Surface,
    text: str,
    font=pygame.font.Font(None, 20),  # <- THAT WAS CHANGED; I had the error message at this point.
...
if __name__ == "__main__":
    main("Music.mp3")  # <- THAT WAS CHANGED; here I put in the name of my music file.